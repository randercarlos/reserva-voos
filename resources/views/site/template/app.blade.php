...
<html lang="pt-br">
    <head>
        <title>{{ $title ?? 'Agência de Turismo' }}</title>
        <meta charset="UTF-8">
    ...
    <body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse">
                    <ul class="menu">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('site.promotions') }}">Promoções</a>
                        </li>
                        @if (auth()->check())
                        <li class="nav-item">
                ...
                @else
                    <div class="main-user-auth">
                        <div class="dropdown">
                            <a href="#" class="dropdown-toggle user-auth" id="dropdownMenuButton"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">

                                @if (auth()->user()->image)
                                    <img src="{{ asset('uploads/users/' . auth()->user()->image) }}"
                                        alt="{{ auth()->user()->name }}" class="img-header-user"
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                ...
                                <a class="dropdown-item" href="{{ route('site.purchases') }}">Minhas Compras</a>
        ...
        <div class="footer-copy">
            <p>Rander Carlos Caetano Freitas ©</p>
        </div><!--Footer Copy-->
        ...
        <script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.11.0/umd/popper.min.js"
            ntegrity="sha384-b/U6ypiBEHpOf/4+1nzFpr53nxSS+GLCkfwBdFNTxtclqqenISfwAzpKaMNFNmj4"
